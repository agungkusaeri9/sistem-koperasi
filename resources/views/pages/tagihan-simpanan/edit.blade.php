...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Edit Tagihan Simpanan</h4>
                    <form action="{{ route('tagihan-simpanan.update', $item->id) }}" method="post">
                        @csrf
                        @method('patch')
                        <div class='form-group mb-3'>
                            ...
                            <select name="jenis" id="jenis" class="form-control @error('jenis') is-invalid @enderror">
                                ...
                                <option @selected($item->jenis === 'wajib') value="wajib">Wajib</option>
                                <option @selected($item->jenis === 'shr') value="shr">SHR</option>
                            </select>
                            @error('jenis')
